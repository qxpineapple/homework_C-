...
namespace OrderWinForm
{
    ...
    public class OrderDetails
    {
        ...
        public OrderDetails(string customerName = null, string itemName = null, int count = 0, string phone = null)
        {
            this.Count = count;
            this.CustomerName = customerName;
            this.ItemName = itemName;
            this.Phone = phone;
            this.Time = System.DateTime.Now.ToShortDateString();
        }

        public OrderDetails(string customerName = null, string itemName = null, int count = 0, string phone = null,string time = null)
        {
            this.Count = count;
            this.CustomerName = customerName;
            this.ItemName = itemName;
    ...
    public class OrderService
    {
        ...
        public void InsertOrder(OrderDetails newOrder)
        {
            ...
            newOrder.Time = newOrder.Time + "/" + newOrder.Id;
        }
        //xml序列化
    ...
    public class Order
    {
        ...
        public Order(string customerName, string itemName, int count, string phone)
        {
            order = new OrderDetails(customerName, itemName, count, phone);
            orderService.InsertOrder(order);
        }
        public Order(string customerName, string itemName, int count, string phone, string time)
        {
            order = new OrderDetails(customerName, itemName, count, phone,time);
            orderService.InsertOrder(order);
        }
        ...
        */
        ...
        //
        public static bool PhoneIsOK(string phone)
        {
            Regex Phone = new Regex("^[0-9]{6}$");
            return Phone.IsMatch(phone);
        }
        public static bool TimeIsOK(string time)
        {
            string mathtable = "^[0-9]{4}/(0[0-9]|1[0-2])/([0-2][0-9]|3[0-1])/周[一二三四五六日]/[0-9]{1,3}$";
            return Regex.IsMatch(time, mathtable);
        }
        ...
        */
        ...
        public static void XmlInput(string xmlFileName)
        {
            try
            {
                ...
                for (int x = n; x > 0; x--)
                {
                    Order o = new Order(CustomerName[x - 1], ItemName[x - 1], Count[x - 1], Phone[x - 1]);
                }
            }
            catch
            {
        ...
        static void StartOrder()
        {
            ...
            switch (flag)
            {
                case 1:
                    ...
                    id = MyInt();
                    order = new Order(itemName, costumerName, id,phone);
                    break;
                case 2:
                    Console.WriteLine();
